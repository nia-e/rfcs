...
Every 12 months, the membership of the libs-fcp team is reshuffled. Any member of the libs team may self-nominate for the position, including those already on the libs-fcp team. The old libs-fcp team (by means delegating this responsibility to a [facilitator], if they so choose) is then to pick between 5 and 8 (inclusive) of the nominees, which will constitute the new team. The new membership list must be approved by all former members of the team; that is, there must be no active objection to the new list.
